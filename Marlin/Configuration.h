...
#define STRING_CONFIG_H_AUTHOR "(massi)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "GT I3 A Pro"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 1.3, 45 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 3, -43, -1.4 }
